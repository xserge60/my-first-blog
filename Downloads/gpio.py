...
class PinBank(PinBankAPI):
    ...
    def pin(self, index, *args, **kwargs):
        print('PiBank pin {0}'.format(index))
        print(self._index_to_soc(index))
...
print('_pi_revision: {0}'.format(_pi_revision))
if _pi_revision == 0:
    ...
    print('5 pi_broadcom_soc {0} '.format(pi_broadcom_soc), pi_header_1)
